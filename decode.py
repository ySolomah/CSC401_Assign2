...
'''
AM = align_ibm1("/u/cs401/A2_SMT/data/Hansard/Training/", 30000, 50, "~") 
LM = lm_train("/u/cs401/A2_SMT/data/Hansard/Training/", "e", "~")
with open("/u/cs401/A2_SMT/data/Hansard/Testing/Task5.f") as freFile, open("/u/cs401/A2_SMT/data/Hansard/Testing/Task5.google.e") as groundTruth:
    for freLine, engTruth in zip(freFile, groundTruth):
        engSentence = decode(preprocess(freLine, 'f', add_null=True), LM, AM)
        print("\nInput french: '" + freLine.strip() + "'")
        print("Output english: '" + engSentence + "'")
        print("Ground truth: '" + engTruth + "'")
'''
